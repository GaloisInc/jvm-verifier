...
| Status | Name                          | Java          | Cryptol      | Impl directly calls | Prereqs | Quickchecks | Verifies | Comments                                                                                                 |
| INPR   | SD Multiply                   | ec_mul        | p384_ref_mul | [fn:10]             |         | no spec     | No       | quickcheck 1 goes OOM; guess is that this cannot simulate in its current form? (more exploration needed) |
