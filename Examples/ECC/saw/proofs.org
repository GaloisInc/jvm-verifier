...
| INPR   | SD Multiply w/ sliding window | ec_mul_window |                  |                     |         |           0 | No            | Implementation uses, but more complex than ^ |
| DONE   | Twin multiplication           | ec_twin_mul   | p384_ec_twin_mul |                     |         |           0 | Yes, rewriter |                                              |

** Level 4: ECDSA
| Status | Name           | Java                | Cryptol                  | Impl directly calls | Prereqs | Quickchecks | Verifies | Comments  |
| DONE   | Signing        | signHash            | p384_ecdsa_sign          |                     |         | 0           | No       |           |
| TODO   | Initialization | initializePublicKey |                          |                     |         | no spec     | No       |           |
| DONE   | Verification   | verifySignature     | p384_ecdsa_public_verify |                     |         | 0           | No       |           |
...
| DONE   | Field Reduction          | field_red     | p384_field_mod     | decFieldPrime, incFieldPrime |           |             | Yes, abc            | ~2m30s   |                                                                                    |
